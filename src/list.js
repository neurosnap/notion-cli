...
List.prototype.createItem = function(opts) {
  var self = this;
...
List.prototype.appendItem = function(options) {
...
List.prototype.insertItem = function(child, options) {
  const content = options.content;
  var i = this.getItemIndex(child);
  if (!~i) return;
...
List.prototype.pushItem = function(options) {
  this.appendItem(options);
